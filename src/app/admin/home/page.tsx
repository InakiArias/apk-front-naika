...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-0 lg:p-6">
        ...
        {links.map(({ name, link }) => (
          ...
          >
            <h2 className="mb-3 text-2xl font-semibold">
              <MaterialIcon name="pie_chart" className="text-blue-900 dark:text-blue-300" /> {name}
            </h2>
